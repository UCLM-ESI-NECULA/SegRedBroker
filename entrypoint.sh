...
#web
iptables -A INPUT -p tcp --dport 8080 -s 10.0.1.2 -j ACCEPT
iptables -A INPUT -p tcp --sport 8080 -s 10.0.1.0/24 -j ACCEPT
iptables -A INPUT -p tcp --dport 8080 -s 10.0.2.3 -j ACCEPT
iptables -A INPUT -p tcp --dport 8080 -s 10.0.2.4 -j ACCEPT
iptables -A INPUT -p tcp --sport 8080 -s 10.0.2.0/24 -j ACCEPT
